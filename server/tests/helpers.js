...
async function resetDb() {
  ...
  await prisma.payrollLineComponent.deleteMany();  // FK → PayrollLine (cascade)
  await prisma.payrollLine.deleteMany();           // FK → PayrollPeriod
  ...
  await prisma.subscriptionRun.deleteMany();
