...
INSERT INTO "new_Employee" ("active", "addressDomisili", "addressKtp", "allowance", "base", "birthDate", "birthPlace", "bpjsKesEnrolled", "bpjsKesStart", "bpjsTkEnrolled", "bpjsTkStart", "contractEnd", "contractStart", "createdAt", "department", "id", "joinedDate", "jp", "maritalStatus", "name", "nip", "noBpjsKes", "noBpjsTk", "noKk", "noSurat", "office", "religion", "risk", "separationDate", "separationNote", "separationReason", "stage", "status", "tjBpjsKes", "tjBpjsTk", "tjKinerja", "tjProfesi", "tjRumahDinas") SELECT "active", "addressDomisili", "addressKtp", "allowance", "base", "birthDate", "birthPlace", "bpjsKesEnrolled", "bpjsKesStart", "bpjsTkEnrolled", "bpjsTkStart", "contractEnd", "contractStart", "createdAt", "department", "id", "joinedDate", "jp", "maritalStatus", "name", "nip", "noBpjsKes", "noBpjsTk", "noKk", "noSurat", "office", "religion", "risk", "separationDate", "separationNote", "separationReason", "stage", "status", "tjBpjsKes", "tjBpjsTk", "tjKinerja", "tjProfesi", "tjRumahDinas" FROM "Employee";
DROP TABLE "Employee";
